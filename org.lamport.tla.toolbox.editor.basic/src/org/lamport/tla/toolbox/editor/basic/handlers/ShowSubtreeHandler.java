...
/**
 * Handler for command that shows the proof subtree rooted
 * at the step currently containing the caret.
 * 
 * @author Daniel Ricketts
 *
 */
public class ShowSubtreeHandler extends ProofFoldCommandHandler
{
        ...
        if (editor != null)
        {
            if (editor.getProofStructureProvider() != null)
            {
                setBaseEnabled(editor.getProofStructureProvider().canRunFoldOperation(
                        IProofFoldCommandIds.EXPAND_SUBTREE,
