...
(*Defn*)ResolvePreviousPathStep2(fileID,priority)==
  \E firstFile \in FileID,labelPath \in LabelSeq:
     /\ firstFile#FilesystemRoot
     /\ KnowPathResolvesToTarget(firstFile,labelPath,fileID)
     /\ UNCHANGED ActiveBorrowerRecords
...
(*Defn*)ResolvePreviousPathStep3(fileID,priority)==
  \E firstFile \in FileID,labelPath \in LabelSeq:
     /\ firstFile#FilesystemRoot
     /\ KnowPathResolvesToTarget(firstFile,labelPath,fileID)
     /\ UNCHANGED ActiveBorrowerRecords
...
(*Defn*)ResolvePreviousPathStep4(fileID,priority)==
  \E firstFile \in FileID,labelPath \in LabelSeq:
     /\ firstFile#FilesystemRoot
     /\ KnowPathResolvesToTarget(firstFile,labelPath,fileID)
     /\ UNCHANGED ActiveBorrowerRecords
...
(*Defn*)ResolvePreviousPathStep5(fileID,priority)==
  \E firstFile \in FileID,labelPath \in LabelSeq:
     /\ firstFile#FilesystemRoot
     /\ KnowPathResolvesToTarget(firstFile,labelPath,fileID)
     /\ UNCHANGED ActiveBorrowerRecords
...
(*Defn*)ResolvePreviousPathStep6(fileID,priority)==
  \E firstFile \in FileID,labelPath \in LabelSeq:
     /\ firstFile#FilesystemRoot
     /\ KnowPathResolvesToTarget(firstFile,labelPath,fileID)
     /\ UNCHANGED ActiveBorrowerRecords
