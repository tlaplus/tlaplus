...
/**
 * Copied from org.eclipse.jdt.internal.ui.text.BufferedDocumentScanner Should
...
public class BufferedDocumentScanner implements ICharacterScanner {
	...
	public final int read() {
		...
		try {
			...
			TLAEditorActivator.getDefault().getLog()
					.log(new Status(IStatus.WARNING, TLAEditorActivator.PLUGIN_ID, buf.toString(), ex));
			throw ex;
		}
	}
