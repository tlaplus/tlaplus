...
public abstract class SemanticNode
    ...
    protected static final ThreadLocal<Errors> errors = new ThreadLocal<>();
    private static final Object[] EmptyArr ;
    private static final AtomicInteger uid;  // the next unique ID for any semantic node
    ...
    static {
        ...
        // Must be the last of the static final variables to be initialized, as it depends on the others
    ...
    protected SemanticNode(final int kind, final TreeNode stn) {
    ...
    public static void setErrors(final Errors errs) {
        errors.set(errs);
    }
    ...
    public final void setKind(final int k) {
        this.kind = k;
    }
