...
public class ParseUnit {
    ...
    public final String getFileName() {
        return (nis != null ? nis.getFileName() : null);
    }

    public final TreeNode getParseTree() {
        return (parseTree != null ? parseTree.rootNode() : null);
    }
    ...
    final ArrayList<ParseUnit> getExtendees() {
        return parseUnitRelatives.extendees;
    }


    final ArrayList<ParseUnit> getInstancees() {
        return parseUnitRelatives.instancees;
    }


    // Add-methods
    final void addExtendee(final ParseUnit pu) {
        parseUnitRelatives.extendees.add(pu);
    }

    final void addExtendedBy(final ParseUnit pu) {
        parseUnitRelatives.extendedBy.add(pu);
    }

    final void addInstancee(final ParseUnit pu) {
        parseUnitRelatives.instancees.add(pu);
    }

    final void addInstancedBy(final ParseUnit pu) {
        parseUnitRelatives.instancedBy.add(pu);
    }
