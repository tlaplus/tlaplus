...
public class SemanticException extends Exception {
  ...
  /**
   * The internal error wrapped by this exception.
   */
  private final AbortException internalException;
  ...
  public ErrorDetails getDetails() {
    return this.internalException.getDetails();
  }
  ...
  public Errors getSourceErrorLog() {
    return this.internalException.getSourceErrorLog();
  }
