...
public class TLAplusParser implements tla2sany.st.SyntaxTreeConstants, ParseTree, TLAplusParserConstants {
  ...
  public TLAplusParser(byte[] sourceInput, java.nio.charset.Charset encoding, tla2sany.output.SanyOutput out) {
    this(new java.io.ByteArrayInputStream(sourceInput), encoding, out);
  }

  public TLAplusParser(java.io.InputStream sourceInput, java.nio.charset.Charset encoding, tla2sany.output.SanyOutput out) {
    this(sourceInput, encoding.name());
    this.out = out;
  }
