...
SyntaxTreeNode tn;
int kind ;
    if (jj_2_38(2) && (BStack.aboveReference( getToken(1).beginColumn))) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case op_76:
      case op_26:
      case op_29:
    ...
    } else if (jj_2_39(2147483647) && (BStack.aboveReference( getToken(1).beginColumn))) {
      /***********************************************************************
...
// note that junction is processed separately.
  ...
  OperatorStack.newStack();
    label_48:
    while (true) {
      if (jj_2_54(2147483647) && (BStack.aboveReference( getToken(1).beginColumn))) {
        ;
      } else {
        break label_48;
      }
    ...
    if (jj_2_55(2147483647) && (BStack.aboveReference( getToken(1).beginColumn))) {
      tn = OpenExpression();
  ...
  bpa("ExtendableExpr") ;
    ...
    while (true) {
      ...
      if (jj_2_59(2147483647) && (BStack.aboveReference( getToken(1).beginColumn))) {
        tn = PostfixOp();
       heirs = new SyntaxTreeNode[2];
       heirs[0] =
       ...
       OperatorStack.pushOnStack(new SyntaxTreeNode(mn, N_GenPostfixOp, heirs),
                                 lastOp);
       if (OperatorStack.size() != 1) {OperatorStack.reduceStack();} ;
      } else if (jj_2_60(2147483647) && (BStack.aboveReference( getToken(1).beginColumn))) {
        t = jj_consume_token(DOT);
       Token next = getToken(1);
       if (isFieldNameToken( next )) next.kind = IDENTIFIER;
      ...
      } else if (jj_2_61(2147483647) && (BStack.aboveReference( getToken(1).beginColumn))) {
    ...
    if (jj_2_66(1)) {
      if (jj_2_64(2147483647) && (BStack.aboveReference( getToken(1).beginColumn))) {
        tn = InfixOp();
     heirs = new SyntaxTreeNode[2];
     heirs[0] = new SyntaxTreeNode( mn, N_IdPrefix, (SyntaxTreeNode []) null);
     heirs[1] = tn ;
     ...
     if (OperatorStack.size() != 1) {OperatorStack.reduceStack();} ;
      ...
      if (OperatorStack.size() != 1) {OperatorStack.reduceStack();} ;
        ...
        if (jj_2_63(2147483647) && (BStack.aboveReference( getToken(1).beginColumn))) {
          tn = OpenExpression();
                            OperatorStack.pushOnStack( tn, null );
        } else if (BStack.aboveReference( getToken(1).beginColumn)) {
          ExtendableExpr();
      ...
      } else if (jj_2_65(2147483647) && (BStack.aboveReference( getToken(1).beginColumn))) {
        t = jj_consume_token(COLONCOLON);
  ...
  bpa("Primitive expression") ;
    if (jj_2_69(2147483647) && (BStack.aboveReference( getToken(1).beginColumn))) {
      tn = String();
    } else if (jj_2_70(2147483647) && (BStack.aboveReference( getToken(1).beginColumn))) {
      tn = Number();
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case op_57:
  ...
  *************************************************************************/
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0x0,0x0,0x0,0x0,0x4,0x100000,0x100000,0x200008,0x0,0x0,0x0,0x0,0x200008,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
