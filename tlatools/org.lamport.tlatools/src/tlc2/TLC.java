            ...
            if (args[index].equals("-simulate") || args[index].equals("-generate")) {
                ...
                if ((index + 1) < args.length) {
                    ...
                    if ("json".equalsIgnoreCase(fmt)) {
                        @SuppressWarnings("unchecked") final List<PostCondition> pcs = (List<PostCondition>) params.computeIfAbsent(
                ...
                if (index < args.length) {
                    @SuppressWarnings("unchecked") final List<PostCondition> pcs = (List<PostCondition>) params
