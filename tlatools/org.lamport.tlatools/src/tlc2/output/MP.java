...
public class MP
{
	...
	private static final java.util.Set<Integer> TLC_SUPPRESSED = new HashSet<>();
	private static final java.util.Set<Integer> TLC_MESSAGES_AS_ERRORS = new HashSet<>();

    // SANY-range message codes
	private static final java.util.Set<ErrorCode> SANY_SUPPRESSED = new HashSet<>();
	private static final java.util.Set<ErrorCode> SANY_MESSAGES_AS_ERRORS = new HashSet<>();
     ...
     */
    public static java.util.Set<Integer> getTlcSuppressedCodes() {
     ...
     */
    public static java.util.Set<Integer> getTlcMessagesAsErrorCodes() {
     ...
     */
    public static java.util.Set<ErrorCode> getSanySuppressedCodes() {
     ...
     * {@code -messagesAsErrors} CLI flag.
     */
    public static java.util.Set<ErrorCode> getSanyMessagesAsErrorCodes() {
