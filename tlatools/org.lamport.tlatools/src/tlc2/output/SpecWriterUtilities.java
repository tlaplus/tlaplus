...
public final class SpecWriterUtilities {
     ...
     *
     * @param moduleFilename filename of a module
     * @param checkExistence if true, the method returns module name, iff the specified file exists or null, if the specified file
     ...
     *
     * @param labelingScheme one of the {@link TLAConstants.Schemes} constants
     * @return Was throwing null-pointer exception when called with spec unparsed.
