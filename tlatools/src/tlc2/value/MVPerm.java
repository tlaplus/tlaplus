...
public final class MVPerm {
  ...
  private final int size() { return this.count; }
  ...
  public static final MVPerm[] permutationSubgroup(final Enumerable enumerable) {
    ...
    while ((elem = Enum.nextElement()) != null) {
      final FcnRcdValue fcn = FcnRcdValue.convert(elem);
      if (fcn == null) {
    ...
    while (true) {
      ...
      for (int i = 0; i < gsz; i++) {
	final MVPerm perm1 = (MVPerm)permVec.elementAt(i);
    ...
    final MVPerm[] res = new MVPerm[permVec.size()];
    final Enumeration permEnum = permVec.elements();
