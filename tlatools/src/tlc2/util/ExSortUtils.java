...
public class ExSortUtils {
  ...
  public static void writeSizeArrayOfExternalSortable 
  (ExternalSortable [] A, int start, int finish, OutputStream out) 
  throws IOException{
  ...
  public static void writeArrayOfExternalSortable
  (ExternalSortable[] A, int start, int finish, OutputStream out) 
  throws IOException {
  ...
  public static ExternalSortable[] readSizeArrayOfExternalSortable
  (InputStream in, ExternalSortable ex) throws IOException  {
    int len;
	...
	("Can't read an array of ExternalSortables from the input stream; it's empty.");
    }
  ...
  /** Reads in as many ExternalSortables as it can and returns an
      ...
      RuntimeException is thrown */
  public static ExternalSortable[] readArrayOfExternalSortable
  (InputStream in, ExternalSortable ex) 
  throws IOException{
  ...
  public static void appendSizeExternalSortableArraySizeArray
  (InputStream in, OutputStream out, ExternalSortable ex)
  throws  IOException {
    int i;
    ExternalSortable a;
    ...
    try {
      ...
      throw new IOException
	("Can't append in to out; in is empty.");
    }
  ...
  public static void appendSizeExternalSortableArrayArray
  (InputStream in, OutputStream out, ExternalSortable ex)
  throws  IOException {
    int i;
    ExternalSortable a;
