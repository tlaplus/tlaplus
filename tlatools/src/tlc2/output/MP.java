...
import tla2sany.output.MessageResolver;
...
public class MP
{
    ...
    private static String getMessage(int messageClass, int messageCode, String[] parameters)
    {
        ...
        // this is a hook to allow parallel editing of the errors
        if (String.valueOf(messageCode).startsWith("4"))
        {
            MessageResolver.resolveSANYMessage(b, messageCode, parameters);
        } else
        {
