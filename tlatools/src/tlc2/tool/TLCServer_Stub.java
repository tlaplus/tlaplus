    ...
    implements tlc2.tool.TLCServerRMI, util.InternRMI, java.rmi.Remote
{
	...
	try {
	    ...
	    useNewInvoke = true;
	    $method_getAppName_0 = tlc2.tool.TLCServerRMI.class.getMethod("getAppName", new java.lang.Class[] {});
	    $method_getCheckDeadlock_1 = tlc2.tool.TLCServerRMI.class.getMethod("getCheckDeadlock", new java.lang.Class[] {});
	    $method_getFPSetManager_2 = tlc2.tool.TLCServerRMI.class.getMethod("getFPSetManager", new java.lang.Class[] {});
	    $method_getIrredPolyForFP_3 = tlc2.tool.TLCServerRMI.class.getMethod("getIrredPolyForFP", new java.lang.Class[] {});
	    $method_getPreprocess_4 = tlc2.tool.TLCServerRMI.class.getMethod("getPreprocess", new java.lang.Class[] {});
	    $method_intern_5 = util.InternRMI.class.getMethod("intern", new java.lang.Class[] {java.lang.String.class});
	    $method_registerWorker_6 = tlc2.tool.TLCServerRMI.class.getMethod("registerWorker", new java.lang.Class[] {tlc2.tool.TLCWorkerRMI.class, java.lang.String.class});
    ...
    public tlc2.tool.FPSetManager getFPSetManager()
	throws java.rmi.RemoteException
    {
	try {
	    if (useNewInvoke) {
		Object $result = ref.invoke(this, $method_getFPSetManager_2, null, -4181204942007244269L);
		return ((tlc2.tool.FPSetManager) $result);
	    } else {
		java.rmi.server.RemoteCall call = ref.newCall((java.rmi.server.RemoteObject) this, operations, 2, interfaceHash);
		ref.invoke(call);
		tlc2.tool.FPSetManager $result;
		try {
		    java.io.ObjectInput in = call.getInputStream();
		    $result = (tlc2.tool.FPSetManager) in.readObject();
		} catch (java.io.IOException e) {
		    throw new java.rmi.UnmarshalException("error unmarshalling return", e);
		} catch (java.lang.ClassNotFoundException e) {
		    throw new java.rmi.UnmarshalException("error unmarshalling return", e);
    ...
    public void registerWorker(tlc2.tool.TLCWorkerRMI $param_TLCWorkerRMI_1, java.lang.String $param_String_2)
