...
public class Simulator implements Cancelable {
	...
	// The total number of states generated by all workers. May be written to
	...
	public void simulate() throws Exception {
		...
		for (int i = 0; i < this.numWorkers; i++) {
			SimulationWorker worker = new SimulationWorker(i, tool, initStates, this.workerResultQueue,
					this.rng.nextLong(), this.traceDepth, this.traceNum, this.checkDeadlock, this.traceFile,
					this.liveCheck, this.numOfGenStates, this.astCounts);
