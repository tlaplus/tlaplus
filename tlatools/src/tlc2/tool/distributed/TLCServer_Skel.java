    ...
    implements java.rmi.server.Skeleton
{
	...
	tlc2.tool.distributed.TLCServer server = (tlc2.tool.distributed.TLCServer) obj;
	switch (opnum) {
	case 0: // getAppName()
	{
	...
	{
	    call.releaseInputStream();
	    tlc2.tool.distributed.FPSetManager $result = server.getFPSetManager();
	    try {
		java.io.ObjectOutput out = call.getResultStream(true);
		out.writeObject($result);
	    } catch (java.io.IOException e) {
	...
	{
	    tlc2.tool.distributed.TLCWorkerRMI $param_TLCWorkerRMI_1;
	    java.lang.String $param_String_2;
	    try {
		java.io.ObjectInput in = call.getInputStream();
		$param_TLCWorkerRMI_1 = (tlc2.tool.distributed.TLCWorkerRMI) in.readObject();
