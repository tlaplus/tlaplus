...
implements Cloneable, Serializable {
  ...
  private TLCStateMutSource(IValue[] vals, SemanticNode[] asts) {
    this.values = vals;
    this.asts = asts;
  }
  ...
  public final TLCState createEmpty() {
    int sz = vars.length;
    return new TLCStateMutSource(new IValue[sz], new SemanticNode[sz]);
  }
  ...
  public final TLCState bind(UniqueString name, IValue value, SemanticNode ast) {
  ...
  throws IOException, ClassNotFoundException {
    this.values = (IValue[])ois.readObject();
    this.asts = null;
  }
