...
public class DFIDModelChecker extends AbstractChecker
{
     ...
     * @param resolver 
     */
    public DFIDModelChecker(String specFile, String configFile, String dumpFile, boolean asDot, final boolean colorize, final boolean actionLabels, boolean deadlock, String fromChkpt,
            boolean preprocess, FilenameToStream resolver, SpecObj specObj) throws EvalException, IOException
    {
        ...
        super(specFile, configFile, dumpFile, asDot, colorize, actionLabels, deadlock, fromChkpt, preprocess, resolver, specObj);
