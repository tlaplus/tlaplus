...
abstract class LiveExprNode {
	...
	public final boolean equals(LiveExprNode exp) {
		if (this instanceof LNNeg) {
			return ((exp instanceof LNNeg) && ((LNNeg) this).getBody().equals(((LNNeg) exp).getBody()));
		}
		if (this instanceof LNNext) {
			return ((exp instanceof LNNext) && ((LNNext) this).getBody().equals(((LNNext) exp).getBody()));
		}
		if (this instanceof LNEven) {
			return ((exp instanceof LNEven) && ((LNEven) this).getBody().equals(((LNEven) exp).getBody()));
		}
		if (this instanceof LNAll) {
			return ((exp instanceof LNAll) && ((LNAll) this).getBody().equals(((LNAll) exp).getBody()));
		}
		if (this instanceof LNState) {
			return ((exp instanceof LNState) && ((LNState) this).getTag() == ((LNState) exp).getTag());
		}
	...
	public final LiveExprNode makeBinary() {
		...
		} else if ((this instanceof LNState) || (this instanceof LNBool)) {
			return this;
		}
