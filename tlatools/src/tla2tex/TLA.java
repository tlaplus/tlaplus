...
class TLA 
 { 
  ...
  static String version = 
    "tla2tex.TLA Version .9 created " + modDate ;
...
//  Debug.print2DArray(spec, "");
      ...
      *********************************************************************/
      ...
      System.out.println("TLATeX dvi output written on " 
      ...
      if (Parameters.PSOutput)
       { /******************************************************************
         ...
         ******************************************************************/
         ...
         MakePSFile();
         Finished("MakePSFile");
         System.out.println("TLATeX Postscript (or pdf) output written on " 
                           + Parameters.LaTeXOutputFile + ".ps (or "
                           + Parameters.LaTeXOutputFile + ".pdf).");
       } 
            ...
            { nextArg = nextArg + 1;
              ...
              try 
               { Parameters.PSGrayLevel = 
                    Misc.stringToFloat(args[nextArg]);
               }
              catch (Exception e)
               { CommandLineError(
                  "Bad -grayLevel value " + args[nextArg]) ;
               } ;
              // bug found by Yuan Yu in following if statement
              // corrected 9 May 2001
              if (   (Parameters.PSGrayLevel > 1)
                  || (Parameters.PSGrayLevel < 0))
               { CommandLineError(
                  "-grayLevel value should be between 0 and 1, not " +
            ...
            { /*************************************************************
              ...
              *************************************************************/
              ...
              if (HasPathPrefix(Parameters.TLAOutFile))
               { CommandLineError(
                    "-tlaOut file contains a path specifier.\n"
                  + "It must be a file in the current directory.") ;
               };
            }
...
//            }
            ...
            { /*************************************************************
              ...
              *************************************************************/
              ...
              if (   (Parameters.UserStyleFile != args[nextArg])
                  && (args[nextArg].indexOf(".sty") !=
                       args[nextArg].length() - 4))
            ...
            { nextArg = nextArg + 1;
              ...
              if (   (Parameters.LaTeXtextwidth < 100)
                  || (Parameters.LaTeXtextwidth > 1000))
                {CommandLineError(
                   "-textwidth value of " + Parameters.LaTeXtextwidth 
                    + " points is implausible");
                } ;
            }
            ...
            { nextArg = nextArg + 1;
              ...
              if (   (Parameters.LaTeXtextheight < 75)
                  || (Parameters.LaTeXtextheight > 1500))
                {CommandLineError(
                   "-textheight value of " + Parameters.LaTeXtextheight 
                    + " points is implausible");
                } ;
            }
            ...
            { nextArg = nextArg + 1;
              ...
              if (   (Parameters.LaTeXhoffset < -250)
                  || (Parameters.LaTeXhoffset > 250))
                {CommandLineError(
                   "-hoffset value of " + Parameters.LaTeXhoffset 
                    + " points is implausible");
                } ;
            }
            ...
            { nextArg = nextArg + 1;
              ...
              if (   (Parameters.LaTeXvoffset < -250)
                  || (Parameters.LaTeXvoffset > 250))
                {CommandLineError(
                   "-voffset value of " + Parameters.LaTeXvoffset 
                    + " points is implausible");
                };
            }
          else 
