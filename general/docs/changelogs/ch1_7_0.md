...
* Error messages have been improved when [temporal existential and/or temporal universal quantification](https://github.com/tlaplus/tlaplus/issues/304) is used in a specification.
