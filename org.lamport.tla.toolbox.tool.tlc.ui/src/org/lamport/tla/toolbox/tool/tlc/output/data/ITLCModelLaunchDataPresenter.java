...
public interface ITLCModelLaunchDataPresenter
{
    ...
    public static final int DISTRIBUTED_SERVER_RUNNING = 4069;
    public static final int DISTRIBUTED_WORKER_REGISTERED = 8192;
	...
	public final static int[] ALL_FIELDS = { USER_OUTPUT, PROGRESS_OUTPUT, START_TIME, END_TIME, LAST_CHECKPOINT_TIME,
			...
			DISTRIBUTED_SERVER_RUNNING, DISTRIBUTED_WORKER_REGISTERED, TLC_MODE };
